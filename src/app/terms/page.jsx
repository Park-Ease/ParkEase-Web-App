...
const TermsAndConditions = () => {
  return (
    <div className="terms-and-conditions">
      <h1>Terms and Conditions for ParkEase</h1>
      <p><strong>Effective Date:</strong> 16th November 2024</p>
      ...
      <h2>1. Definitions</h2>
      <ul>
        <li><strong>"Service"</strong> refers to the ParkEase application, website, and any related services provided.</li>
        <li><strong>"User"</strong> refers to anyone who accesses or uses the Service.</li>
        <li><strong>"We," "Us," or "Our"</strong> refers to ParkEase and its affiliates.</li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Account Creation:</strong> Users must create an account to access certain features of the Service. You
      ...
      <ul>
        ...
        <li>
          Disputes must be resolved through arbitration or mediation before seeking legal remedies in court.
        </li>
      </ul>
      ...
      <p>
        ...
        Email: <a href="mailto:sslayer441@gmail.com">sslayer441@gmail.com</a> <br />
        Phone: +91 9613711667
      </p>
    </div>
  );
