...
const Testimonials = () => {
  return (
    <section id="testimonials" className="relative flex flex-col items-center w-full bg-[#fcd904]/80">
      <h2 className='text-6xl font-funnel-display font-bold mt-32'>What Our Customers Say</h2>
      <h2 className='text-6xl font-funnel-display font-bold flex items-center'>
        About Our
        <GravityTextSwap
        textArray={["Team", "Product", "Support"]}
        duration={1}
        pauseDuration={1.5}
        className="text-6xl font-funnel-display font-bold ml-3 text-center"
        />
      </h2>
